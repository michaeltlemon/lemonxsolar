<?php
  if (isset($_POST['email']))  {
    ...
    //Email information
    $admin_email = "michael@lemonprograms.com";
    $name = $_POST['name'];
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    ...
    header('Location: http://lemonprograms.com/success.html');
  }
  ...
  $host=$_SERVER['lemonprograms.com'];
  $ip=$_SERVER['162.241.217.219'];
  $from="michael@lemonprograms.com";
